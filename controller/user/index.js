  ...
  categoryListController: (req, res) => {
    ...
    jwt.verify(token, jwtObj.secret, (err, decoded) => {
      ...
      if (decoded) {
        ...
        // 검색결과의 categories_id를 categories테이블에서 모두 찾아서
  ...
  addCategoryController: (req, res) => {
    ...
    jwt.verify(token, jwtObj.secret, (err, decoded) => {
      ...
      if (decoded) {
        ...
        //       checkList.push(data[i].dataValues.id);
        //     }
        //     users_categories
        //       .findAll({
        //         where: {
        ...
        //           checkList.push(data[i].dataValues.users_id);
        //         }
        ...
        //               users_categories
        //                 .create({
        //                   categories_id: data.dataValues.id,
        //                   users_id: decoded.id
        //                 })
  ...
  categoryController: (req, res) => {
    ...
    jwt.verify(token, jwtObj.secret, (err, decoded) => {
      ...
      if (decoded) {
        ...
        //               checkList.push(JSON.parse(data[i].dataValues.video));
        //             }
        //             if (checkList.length === 0) {
        //               res.status(204).end();
        //             } else {
  ...
  deleteCategoryController: (req, res) => {
    ...
    jwt.verify(token, jwtObj.secret, (err, decoded) => {
      ...
      if (decoded) {
        ...
        //           checkList.push(data[i].dataValues);
        //         }
        //         let cid; // 카테고리아이디
